...
public class homework {
    ...
    public static void main(String[] args) {
        ...
        try {
            bf = new BufferedReader(new FileReader(new File("C:\\Users\\Dhruv Bajpai\\Dropbox\\USC Data\\CSCI 561 - Foundations of Artificial Intelligence\\Homework\\HomeWork 2 - CandyCrush Type\\src\\firstTry\\input.txt")));
...
//            System.out.println("Nodes analysed per ms: "+ ((double)nodeCounter/(t2-t1)));
            System.out.println("Nodes analysed : "+ nodeCounter);
...
/*
    ...
    private static void writeOutput(char[][] newConfig, int p, int q,int score) throws IOException {
        ...
        try {
            ...
            bw = new BufferedWriter(new FileWriter("C:\\Users\\Dhruv Bajpai\\Dropbox\\USC Data\\CSCI 561 - Foundations of Artificial Intelligence\\Homework\\HomeWork 2 - CandyCrush Type\\src\\firstTry\\ouput.txt"));
            bw.write((char)(q+65));
